...
# API base URL
API_BASE_URL = "https://backend-asn8.onrender.com/api"
...
const registerUser = async (userData) => {
  try {
    const response = await fetch('https://backend-asn8.onrender.com/api/auth/register', {
      method: 'POST',
      headers: {
...
const loginUser = async (credentials) => {
  try {
    const response = await fetch('https://backend-asn8.onrender.com/api/auth/login', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
const getCurrentUser = async () => {
  try {
    ...
    const response = await fetch('https://backend-asn8.onrender.com/api/users/me', {
      method: 'GET',
      headers: {
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const login = async (credentials: { username: string; password: string }) => {
    ...
    try {
      ...
      // Fetch user data
      const userResponse = await fetch('https://backend-asn8.onrender.com/api/users/me', {
        headers: {
...
export const UserDataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      const response = await fetch('https://backend-asn8.onrender.com/api/users/me/profile', {
        headers: {
          'Authorization': `Bearer ${token}`,
        },
      });
  ...
  const updateProfile = async (profileData: any) => {
    ...
    try {
      const response = await fetch('https://backend-asn8.onrender.com/api/profile', {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const addAddress = async (addressData: any) => {
    ...
    try {
      const response = await fetch('https://backend-asn8.onrender.com/api/profile/addresses', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const updateAddress = async (addressId: string, addressData: any) => {
    ...
    try {
      const response = await fetch(`https://backend-asn8.onrender.com/api/profile/addresses/${addressId}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const addBankDetail = async (bankData: any) => {
    ...
    try {
      const response = await fetch('https://backend-asn8.onrender.com/api/profile/bank-details', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const updateBankDetail = async (bankId: string, bankData: any) => {
    ...
    try {
      const response = await fetch(`https://backend-asn8.onrender.com/api/profile/bank-details/${bankId}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
...
1. Update API Base URL:
   ...
   - Example: const API_BASE_URL = 'https://backend-asn8.onrender.com/api';
