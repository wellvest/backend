...
export const UserDataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const addAddress = async (addressData: any) => {
    ...
    try {
      const response = await fetch('http://localhost:8000/api/profile/addresses', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const updateAddress = async (addressId: string, addressData: any) => {
    ...
    try {
      const response = await fetch(`http://localhost:8000/api/profile/addresses/${addressId}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const addBankDetail = async (bankData: any) => {
    ...
    try {
      const response = await fetch('http://localhost:8000/api/profile/bank-details', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const updateBankDetail = async (bankId: string, bankData: any) => {
    ...
    try {
      const response = await fetch(`http://localhost:8000/api/profile/bank-details/${bankId}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
...
1. Update API Base URL:
   ...
   - Example: const API_BASE_URL = 'http://localhost:8000/api';
