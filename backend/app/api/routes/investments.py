...
async def create_investment(
    ...
    # Update user's profile with the current plan and plan amount
    if current_user.profile:
        current_user.profile.plan_amount = investment_in.amount
        if plan:
            current_user.profile.current_plan_id = plan.id
