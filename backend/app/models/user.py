...
class User(Base):
    ...
    current_plans = relationship("CurrentPlan", back_populates="user")
...
class Profile(Base):
    ...
    total_invested_amount = Column(Float, default=0.0)  # Track total invested amount for interest calculation
