...
import os
from app.api.routes import auth, users, profile, investments, wallets, network, uploads, referrals, contact, plans, noc, bonus, auth_reset_password, notifications, otp
